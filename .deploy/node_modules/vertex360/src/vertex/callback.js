...
const setVertexSession = function(req, headers){
	...
	var res = {
		...
		json: function(data){
			...
			callback(null, {
				...
				statusCode: 200,
				headers: setVertexSession(req, headers),
				headers: headers,
...
module.exports = function(event, callback, routeParams, opts){ // opts can be null
...
//		url: event.path
	...
	if (ck == null){
		return {
			req: req,
			res: configureResponse(req, callback, opts)
		}
	}
